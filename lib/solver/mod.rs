        ...
        Check::Sat => {
            Model::new(&context, &solver)
                ...
                .and_then(|numeral_dec_str| {
                    ir::Constant::from_decimal_string(
                        &numeral_dec_str,
                        bits
                    ).ok()
                })
