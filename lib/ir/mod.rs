...
pub use self::location::{FunctionLocation,
                         ProgramLocation,
                         RefFunctionLocation,
                         RefProgramLocation};
...
pub fn dereference_expr<V: Value>(
    expr: Expression<V>
) -> Expression<V> {
...
pub fn add<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::add(lhs, rhs) }

pub fn sub<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::sub(lhs, rhs) }

pub fn mul<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::mul(lhs, rhs) }

pub fn divu<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::divu(lhs, rhs) }

pub fn modu<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::modu(lhs, rhs) }

pub fn divs<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::divs(lhs, rhs) }

pub fn mods<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::mods(lhs, rhs) }

pub fn and<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::and(lhs, rhs) }

pub fn or<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::or(lhs, rhs) }

pub fn xor<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::xor(lhs, rhs) }

pub fn shl<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::shl(lhs, rhs) }

pub fn shr<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::shr(lhs, rhs) }

pub fn cmpeq<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::cmpeq(lhs, rhs) }

pub fn cmpneq<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::cmpneq(lhs, rhs) }

pub fn cmplts<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::cmplts(lhs, rhs) }

pub fn cmpltu<V: Value>(lhs: Expression<V>, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::cmpltu(lhs, rhs) }

pub fn trun<V: Value>(bits: usize, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::trun(bits, rhs) }

pub fn zext<V: Value>(bits: usize, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::zext(bits, rhs) }

pub fn sext<V: Value>(bits: usize, rhs: Expression<V>)
    -> Result<Expression<V>> { Expression::sext(bits, rhs) }
...
fn reduce_binop<F, G, H>(
    ...
    isize_op: H
     ...
     where F: Fn(Expression<Constant>, Expression<Constant>) -> Result<Expression<Constant>>,
        ...
        if let Some(r) = rhs.constant() {
            ...
            return
                Ok(
                    Reference::new(
                        StackVariable::new(
                            isize_op(l.offset(), r_i64 as isize),
                            l.bits()
                        ).into(),
                        lhs.bits()
                    ).into()
        ...
        if let Some(r) = rhs.stack_pointer() {
            ...
            return
                Ok(
                    Reference::new(
                        StackVariable::new(
                            isize_op(r.offset(), l_i64 as isize),
                            r.bits()
                        ).into(),
                        rhs.bits()
                    ).into()
    ...
    let expr_out = match expr {
        Expression::LValue(lvalue) => match lvalue.as_ref() {
            ...
            LValue::Dereference(dereference) =>
                dereference_expr(reduce(dereference.expression())?)
        },
        Expression::RValue(rvalue) => match rvalue.as_ref() {
            RValue::Value(_) => expr.clone(),
            RValue::Reference(reference) =>
                reference_expr(reduce(reference.expression())?,
                               reference.bits())
        }
        Expression::Add(lhs, rhs) =>
            reduce_binop(reduce(lhs)?,
                         reduce(rhs)?,
                         Expression::add,
...
pub fn simplify(expr: &Expression<Constant>) -> Option<Expression<Constant>> {
    match expr {
        Expression::Add(lhs, rhs) => {
            ...
            else if lhs.constant().map(|constant| constant.is_zero()).unwrap_or(false) {
