    ...
    pub fn from_il(expression: &il::Expression) -> Expression<Constant> {
        match expression {
            ...
            il::Expression::Add(lhs, rhs) =>
                Expression::Add(Box::new(Expression::from_il(lhs)),
                                Box::new(Expression::from_il(rhs))),
            il::Expression::Sub(lhs, rhs) =>
                Expression::Sub(Box::new(Expression::from_il(lhs)),
                                Box::new(Expression::from_il(rhs))),
            il::Expression::Mul(lhs, rhs) =>
                Expression::Mul(Box::new(Expression::from_il(lhs)),
                                Box::new(Expression::from_il(rhs))),
            il::Expression::Divu(lhs, rhs) =>
                Expression::Divu(Box::new(Expression::from_il(lhs)),
                                 Box::new(Expression::from_il(rhs))),
            il::Expression::Modu(lhs, rhs) =>
                Expression::Modu(Box::new(Expression::from_il(lhs)),
                                 Box::new(Expression::from_il(rhs))),
            il::Expression::Divs(lhs, rhs) =>
                Expression::Divs(Box::new(Expression::from_il(lhs)),
                                 Box::new(Expression::from_il(rhs))),
            il::Expression::Mods(lhs, rhs) =>
                Expression::Mods(Box::new(Expression::from_il(lhs)),
                                Box::new(Expression::from_il(rhs))),
            il::Expression::And(lhs, rhs) =>
                Expression::And(Box::new(Expression::from_il(lhs)),
                                Box::new(Expression::from_il(rhs))),
            il::Expression::Or(lhs, rhs) =>
                Expression::Or(Box::new(Expression::from_il(lhs)),
                               Box::new(Expression::from_il(rhs))),
            il::Expression::Xor(lhs, rhs) =>
                Expression::Xor(Box::new(Expression::from_il(lhs)),
                                Box::new(Expression::from_il(rhs))),
            il::Expression::Shl(lhs, rhs) =>
                Expression::Shl(Box::new(Expression::from_il(lhs)),
                                Box::new(Expression::from_il(rhs))),
            il::Expression::Shr(lhs, rhs) =>
                Expression::Shr(Box::new(Expression::from_il(lhs)),
                                Box::new(Expression::from_il(rhs))),
            il::Expression::Cmpeq(lhs, rhs) =>
                Expression::Cmpeq(Box::new(Expression::from_il(lhs)),
                                  Box::new(Expression::from_il(rhs))),
            il::Expression::Cmpneq(lhs, rhs) =>
                Expression::Cmpneq(Box::new(Expression::from_il(lhs)),
                                   Box::new(Expression::from_il(rhs))),
            il::Expression::Cmpltu(lhs, rhs) =>
                Expression::Cmpltu(Box::new(Expression::from_il(lhs)),
                                   Box::new(Expression::from_il(rhs))),
            il::Expression::Cmplts(lhs, rhs) =>
                Expression::Cmplts(Box::new(Expression::from_il(lhs)),
                                   Box::new(Expression::from_il(rhs))),
...
impl<V: Value> Expression<V> {
    ...
    pub fn all_values(&self) -> bool {
        match self {
            ...
            Expression::Cmplts(lhs, rhs) =>
                lhs.all_values() && rhs.all_values(),
            Expression::Trun(_, rhs) |
            Expression::Zext(_, rhs) |
            Expression::Sext(_, rhs) => rhs.all_values(),
    ...
    pub fn replace_expression(
        ...
        match self {
                ...
                LValue::Dereference(dereference) =>
                    Ok(dereference_expr(
                        dereference.expression()
                            .replace_expression(needle, expr)?))
            },
            Expression::RValue(rvalue) => match rvalue.as_ref() {
            ...
            Expression::Add(lhs, rhs) =>
                Expression::add(lhs.replace_expression(needle, expr)?,
                                rhs.replace_expression(needle, expr)?),
            Expression::Sub(lhs, rhs) =>
                Expression::sub(lhs.replace_expression(needle, expr)?,
                                rhs.replace_expression(needle, expr)?),
            Expression::Mul(lhs, rhs) =>
                Expression::mul(lhs.replace_expression(needle, expr)?,
                                rhs.replace_expression(needle, expr)?),
            Expression::Divu(lhs, rhs) =>
                Expression::divu(lhs.replace_expression(needle, expr)?,
                                 rhs.replace_expression(needle, expr)?),
            Expression::Modu(lhs, rhs) =>
                Expression::modu(lhs.replace_expression(needle, expr)?,
                                 rhs.replace_expression(needle, expr)?),
            Expression::Divs(lhs, rhs) =>
                Expression::divs(lhs.replace_expression(needle, expr)?,
                                 rhs.replace_expression(needle, expr)?),
            Expression::Mods(lhs, rhs) =>
                Expression::mods(lhs.replace_expression(needle, expr)?,
                                 rhs.replace_expression(needle, expr)?),
            Expression::And(lhs, rhs) =>
                Expression::and(lhs.replace_expression(needle, expr)?,
                                rhs.replace_expression(needle, expr)?),
            Expression::Or(lhs, rhs) =>
                Expression::or(lhs.replace_expression(needle, expr)?,
                               rhs.replace_expression(needle, expr)?),
            Expression::Xor(lhs, rhs) =>
                Expression::xor(lhs.replace_expression(needle, expr)?,
                                rhs.replace_expression(needle, expr)?),
            Expression::Shl(lhs, rhs) =>
                Expression::shl(lhs.replace_expression(needle, expr)?,
                                rhs.replace_expression(needle, expr)?),
            Expression::Shr(lhs, rhs) =>
                Expression::shr(lhs.replace_expression(needle, expr)?,
                                rhs.replace_expression(needle, expr)?),
            Expression::Cmpeq(lhs, rhs) =>
                Expression::cmpeq(lhs.replace_expression(needle, expr)?,
                                  rhs.replace_expression(needle, expr)?),
            Expression::Cmpneq(lhs, rhs) =>
                Expression::cmpneq(lhs.replace_expression(needle, expr)?,
                                   rhs.replace_expression(needle, expr)?),
            Expression::Cmpltu(lhs, rhs) =>
                Expression::cmpltu(lhs.replace_expression(needle, expr)?,
                                   rhs.replace_expression(needle, expr)?),
            Expression::Cmplts(lhs, rhs) =>
                Expression::cmplts(lhs.replace_expression(needle, expr)?,
                                   rhs.replace_expression(needle, expr)?),
    ...
    pub fn variables(&self) -> Vec<&Variable> {
        let mut variables = match self {
            ...
            Expression::RValue(rvalue) => match rvalue.as_ref() {
                ...
                RValue::Reference(reference) =>
                    reference.expression().variables()
            },
            Expression::Add(lhs, rhs) |
            Expression::Sub(lhs, rhs) |
            Expression::Mul(lhs, rhs) |
            ...
            Expression::Trun(_, rhs) |
            Expression::Sext(_, rhs) |
            Expression::Zext(_, rhs) => rhs.variables(),
            Expression::Ite(cond, then, else_) => {
    ...
    pub fn contains_reference(&self) -> bool {
        match self {
            Expression::LValue(lvalue) => match lvalue.as_ref() {
                ...
                LValue::Dereference(dereference) =>
                    dereference.expression().contains_reference()
            },
            Expression::RValue(rvalue) => match rvalue.as_ref() {
            ...
            Expression::Trun(_, rhs) |
            Expression::Sext(_, rhs) |
            Expression::Zext(_, rhs) => rhs.contains_reference(),
            Expression::Ite(cond, then, else_) =>
                cond.contains_reference() ||
                then.contains_reference() ||
                else_.contains_reference()
        }
    }
    ...
    pub fn trun(bits: usize, rhs: Expression<V>) -> Result<Expression<V>> {
        if bits >= rhs.bits() { return Err(ErrorKind::Sort.into()); }
